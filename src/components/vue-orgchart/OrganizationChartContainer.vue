...
.orgchart .lines .topLine {
  border-top: 2px solid rgba(83, 82, 82, 0.8);
}

.orgchart .lines .rightLine {
  border-right: 1px solid rgba(83, 82, 82, 0.8);
  float: none;
  border-radius: 0;
}

.orgchart .lines .leftLine {
  border-left: 1px solid rgba(83, 82, 82, 0.8);
  float: none;
  border-radius: 0;
}
...
.orgchart .node .content {
  ...
  font-size: 11px;
  line-height: 18px;
  border: 1px solid rgba(83, 82, 82, 0.8);
